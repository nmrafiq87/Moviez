...
public class MovieData implements Parcelable
{
    ...
    @Expose
    private List<data.Genre> genres = null;
    ...
    protected MovieData(Parcel in) {
        ...
        in.readList(this.productionCompanies, (data.ProductionCompany.class.getClassLoader()));
        this.releaseDate = ((String) in.readValue((String.class.getClassLoader())));
        this.revenue = ((Integer) in.readValue((Integer.class.getClassLoader())));
        this.runtime = ((Integer) in.readValue((Integer.class.getClassLoader())));
        in.readList(this.spokenLanguages, (data.SpokenLanguage.class.getClassLoader()));
    ...
    public List<data.Genre> getGenres() {
        return genres;
    }

    public void setGenres(List<data.Genre> genres) {
        this.genres = genres;
    }
